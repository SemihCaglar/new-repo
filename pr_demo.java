...
public class DemoPR {
    ...
    public static void main(String[] args) {
        ...
        // Obvious: This is obvious from the code below.
        int a = 5; // Setting variable a to 5

        // Vague: The comment does not clearly explain what compute() does.
    ...
    /**
     * Demonstrates beautification comments.
     *
     * Beautification: This comment block is used solely for decorative purposes.
     */
